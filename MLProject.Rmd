...
OOSerror <-1-max(rfModel$results$Accuracy
```
...
The out of sample error is **`r OOSerror`**. The out of sample error is calculated as 1 - accuracy for predictions made against the cross-validation set. Given the accuracy rate is above 99% few if any of the test samples will be mis-classified.
